...
export function Footer() {
  return (
    <footer className="bg-nutribowl-brown text-[#FFD89E] border-t border-[#442C16] py-12 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center md:items-start text-center md:text-left">
          ...
          <div className="md:px-8">
            ...
            <ul className="text-[#C4B4A4] text-sm space-y-2.5">
              <li className="flex items-center justify-center md:justify-start gap-2">
                <span className="text-nutribowl-softOrange">🌅</span> Prepared fresh daily before 6 AM
              </li>
              <li className="flex items-center justify-center md:justify-start gap-2">
                <span className="text-nutribowl-softOrange">🥗</span> 100% natural, no additives
              </li>
              <li className="flex items-center justify-center md:justify-start gap-2">
                <span className="text-nutribowl-softOrange">🌾</span> Organic rolled oats & artisanal breads
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col items-center md:items-start gap-3.5 text-sm text-[#C4B4A4]">
              <a 
                href="https://www.instagram.com/nutribowl.hyd" 
                target="_blank" 
                rel="noreferrer" 
                className="flex items-center gap-2.5 hover:text-white transition-colors group"
              >
                <span className="p-2 rounded-full bg-[#4E341A] group-hover:bg-nutribowl-orange group-hover:text-white transition-colors">
                  <Instagram size={15} />
                </span>
                <span>@nutribowl.hyd on Instagram</span>
              </a>
        ...
        <div className="border-t border-[#4E341A] mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center text-center gap-4 text-xs text-[#C4B4A4]">
          <p>© {new Date().getFullYear()} Nutribowl Breakfast Co. All rights reserved.</p>
          <p className="flex items-center gap-1.5 justify-center">
            Handcrafted with <Heart size={12} className="text-nutribowl-orange fill-nutribowl-orange animate-pulse" /> in Hyderabad
          </p>
        </div>
